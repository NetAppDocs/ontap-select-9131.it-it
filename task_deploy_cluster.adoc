...
TIP: Se l'operazione di creazione del cluster viene avviata ma non viene completata, la password amministrativa di ONTAP definita potrebbe non essere applicata. In questo caso, contattare il supporto tecnico NetApp per assistenza.
